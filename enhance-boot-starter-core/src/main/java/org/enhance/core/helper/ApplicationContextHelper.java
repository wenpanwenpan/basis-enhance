 ...
 * spring容器助手
 * <p>
 * 关于spring容器关系的分析，可参考<a>https://zhuanlan.zhihu.com/p/161401436</a>
 * </p>
 *
 * @author wenpanfeng 2022/9/30 13:50
 */
public class ApplicationContextHelper implements ApplicationContextAware {
    ...
    /**
     * <p>
     * DefaultListableBeanFactory是spring的BeanFactory默认实现，BeanFactory实现分为以下三种
     *     <ol>
     *         <li>StaticListableBeanFactory可以看做是基于 Map<String，Object>的简单封装，不包括Bean的实例化过程，
     *         需要用户手动注册后才可以使用，不具备依赖注入能力，是 BeanFactory最为简单的实现；</li>
     *         <li>DefaultListableBeanFactory是Spring BeanFactory的默认实现，是Spring IoC容器中最为复杂的部分</li>
     *         <li>SimpleJndiBeanFactory则是基于JNDI场景发现对应Bean（很少用到）</li>
     *     </ol>
     * </p>
     */
     ...
     * spring容器
     * <ol>
     *     <li>从 ApplicationContext 继承的接口上看，接口 ApplicationContext 继承了接口 ListableBeanFactory 、
     *     HierarchicalBeanFactory 、 EnvironmentCapable 、MessageSource 、 ApplicationEventPublisher 、
     *     ResourcePatternResolver，提供IoC容器能力、环境管理、事件发布机制、事件发布-响应机制、资源定位加载、i18n的能力</li>
     * </ol>
     * </p>
     */
